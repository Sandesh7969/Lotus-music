        ...
        this.run = async (interaction) => {
            if (interaction.isButton()) {
                ...
                if (interaction.customId === `oras_classic_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "trixo-classic");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Trixo Classic Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `oras_spotify_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "trixo-spotify");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Trixo x Spotify Mode\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `oras_simple_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "trixo-simple");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Trixo Simple Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `oras_special_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "trixo-special");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Trixo Special Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `oras_no_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "trixo-no");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Trixo No Buttons Mode\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                ...
                if (interaction.customId === `oras_old_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "trixo-old");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Trixo Old School Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
