    ...
    constructor(client) {
        ...
        this.exec = async (message, args, prefix) => {
                ...
                if (!hex)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`${this.client.emoji.cross} Please provide me a hex color`),
                        ],
                    });
                hex = checkHex(args[1]);
                if (hex === false)
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`${this.client.emoji.cross} Please provide me a valid hex color code!`),
                        ],
                    });
                if (get.HEXCODE === null) {
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(message.guildId)
                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** Embeds Color to \`${args[1]}\``),
                        ],
                    });
                }
                else {
                        ...
                        if (interaction.customId === `yes`) {
                            ...
                            return interaction.update({
                                embeds: [
                                    this.client.utils
                                        .premiumEmbed()
                                        .setDescription(`${this.client.emoji.tick} Successfully Set the custom embed color to: \`${args[1]}\`.`),
                                ],
                                components: [],
                            });
                        }
                            ...
                            return interaction.update({
                                embeds: [
                                    this.client.utils
                                        .premiumEmbed()
                                        .setDescription(`${this.client.emoji.cross} Cancelled the Interaction`),
                                ],
                                components: [],
                            });
                        }
            ...
            if (args[0].toLowerCase() === `player`) {
                ...
                let b1 = this.client.utils.button(`custom_id`, `Trixo Classic`, 2, `oras_classic_mode`);
                let b2 = this.client.utils.button(`custom_id`, `Trixo x Spotify`, 3, `oras_spotify_mode`);
                let b3 = this.client.utils.button(`custom_id`, `Trixo Simple`, 2, `oras_simple_mode`);
                let b4 = this.client.utils.button(`custom_id`, `Trixo Special`, 1, `oras_special_mode`);
                let b5 = this.client.utils.button(`custom_id`, `No Buttons Style`, 2, `oras_no_mode`);
                let b6 = this.client.utils.button(`custom_id`, `Trixo Old School`, 2, `oras_old_mode`);
            ...
            if (args[0].toLowerCase() === `dj` ||
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`\`${prefix}setup dj create\`
                ...
                if (args[1].toLowerCase() === `create`) {
                    if (this.client.utils.checkDjSetup(message.guildId) === true) {
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`${this.client.emoji.cross} Setup Already exists at <#${this.client.utils.djSetupChannel(message.guildId)}>`),
                            ],
                        });
                    }
                    ...
                    if (!channel)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`${this.client.emoji.cross} Please provide me a valid channel to be created setup on!`),
                            ],
                        });
                    if (!message.guild.members.me.permissionsIn(channel).has("ViewChannel"))
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} I don't have **View Channel** permissions in that channel!`)
                    ...
                    if (!message.guild.members.me.permissionsIn(channel).has("SendMessages"))
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} I don't have **Send Messages** permissions in that channel!`)
                                    .setTitle(`Missing Permissions`),
                            ],
                        });
                    if (!message.guild.members.me
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} I don't have **Read Message History** permissions in that channel!`)
                                    .setTitle(`Missing Permissions`),
                            ],
                        });
                    if (!message.guild.members.me
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} I don't have **Use External Emojis** permissions in that channel!`)
                                    .setTitle(`Missing Permissions`),
                            ],
                        });
                    if (!message.guild.members.me.permissionsIn(channel).has("EmbedLinks"))
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} I don't have **Embed Links** permissions in that channel!`)
                                    .setTitle(`Missing Permissions`),
                            ],
                        });
                    if (!message.guild.members.me
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} I don't have **Manage Channels** permissions in that channel!`)
                                    .setTitle(`Missing Permissions`),
                            ],
                        });
                    if (!message.guild.members.me
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} I don't have **Manage Messages** permissions in that channel!`)
                                    .setTitle(`Missing Permissions`),
                            ],
                        });
                    channel.send(``);
                    ...
                    let b3 = this.client.utils.button(`custom_id`, null, 2, `oras_dj_pause`, null, this.client.emoji.setup.pause);
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setDescription(`${this.client.emoji.tick} Successfully **Created** Music Setup at ${channel}. Hope you enjoy me there`),
                        ],
                    });
                }
                    ...
                    if (this.client.utils.checkDjSetup(message.guildId) === false)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} There is no setup for this guild right now!`),
                            ],
                        });
                    ...
                    return message.reply({
                        embeds: [
                            this.client.utils
                                ...
                                .setTimestamp()
                                .setTitle(`Deleted`)
                                .setDescription(`${this.client.emoji.tick} Successfully **Deleted** Server Music Setup`),
                        ],
                    });
                }
                if (args[1].toLowerCase() === `fix`) {
                    ...
                    if (ch) {
                        let msg = await ch.messages.fetch(setup.MESSAGE);
                        if (!msg) {
                            ch.send(`https://media.discordapp.net/attachments/1094179370966470666/1128356646113005688/Picsart_23-07-11_20-30-52-826.jpg`);
                            let content = `__**Queue List**__\n\nJoin a Voice Channel and type in your Search Query or a Url`;
                            let em = this.client.utils
                                .embed()
                                .setTitle(`Nothing Playing Right Now`)
                            ...
                            return message.reply({
                                embeds: [
                                    this.client.utils
                                        .premiumEmbed(message.guildId)
                                        .setDescription(`${this.client.emoji.tick} Successfully **Fixed** the Music Setup`)
                            ...
                            return message.reply({
                                embeds: [
                                    this.client.utils
                                        .errorEmbed()
                                        .setDescription(`${this.client.emoji.cross} Setup seems to be fine`),
                                ],
                            });
                    }
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`${this.client.emoji.tick} Successfully **Fixed** the Music Setup. Create a new one using \`setup dj create\``)
                                    .setTitle(`Setup Fixed`)
                                    .setTimestamp(),
                            ],
                        });
                    ...
                    if (this.client.utils.checkDjSetup(message.guildId) === false)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} There is no setup for this guild yet!`),
                            ],
                        });
                    ...
                    if (!role)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .errorEmbed()
                                    .setDescription(`${this.client.emoji.cross} Please provide me a valid role`),
                            ],
                        });
                    ...
                    if (get === null || !pn) {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guild.id)
                                    .setDescription(`${this.client.emoji.tick} Successfully **Updated** Djrole to ${role}`)
                        ...
                        let em = this.client.utils
                            ...
                            .setTimestamp();
                        let b1 = this.client.utils.button(`custom_id`, `Confirm`, 3, `yeah`, null, this.client.emoji.tick);
                        let b2 = this.client.utils.button(`custom_id`, `Decline`, 4, `nope`, null, this.client.emoji.cross);
                        let buttons = [b1, b2];
                        let row = this.client.utils.actionRow(buttons);
                        let msg = await message.reply({
                            embeds: [em],
                    ...
                    if (get === null)
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guildId)
                                    .setDescription(`${this.client.emoji.cross} There is no djrole setupped for this guild`),
                            ],
                        });
                    else {
                        ...
                        return message.reply({
                            embeds: [
                                this.client.utils
                                    .premiumEmbed(message.guild.id)
                                    .setDescription(`${this.client.emoji.tick} Successfully **Deleted** Dj role for the server`),
                            ],
                        });
                    }
                }
                            ...
                            return interaction.update({
                                embeds: [
                                    this.client.utils
                                        ...
                                        .setDescription(`${this.client.emoji.tick} Successfully **Updated** Play style to: \`Buttons\``),
                                ],
                                components: [],
                            });
                        }
                            ...
                            return interaction.update({
                                embeds: [
                                    this.client.utils
                                        .premiumEmbed(message.guildId)
                                        .setTitle(`Updated Play Style`)
                                        .setDescription(`${this.client.emoji.tick} Play style has been **Updated** to: \`Direct\``),
                                ],
                                components: [],
                            });
                        }
