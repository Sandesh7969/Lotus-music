...
class muzicard {
    ...
    async build() {
        ...
        if (!this.author) throw new Error('No Author Provided');
        if (!this.color) this.setColor('purple');
        if (!this.theme) this.setTheme('neonx');
        if (!this.brightness) this.setBrightness(50);
        ...
        if (this.theme == 'classic') {
            ...
            const background = await canvas.loadImage(`https://media.discordapp.net/attachments/1155364683755307028/1195290891452153996/Untitled_design.png?ex=65b37463&is=65a0ff63&hm=38b6fe1ee7f42625d70ec3d2884062495113c3cc9d656583f0271cd7a5818fa7&=&format=webp&quality=lossless&size=4096`);
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://images-ext-2.discordapp.net/external/i4jSXo-w-Ccf8s7NHi75HW9o8AcgSS9wYtS5bjBXqRE/https/img.freepik.com/premium-photo/digital-painting-synthwave-retrowave-landscape-sunset-vaporwave_805816-65.jpghttps%3A/img.freepik.com/premium-photo/digital-painting-synthwave-retrowave-landscape-sunset-vaporwave_805816-65.jpg?format=webp&size=4096`);
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://media.discordapp.net/attachments/1152621602614280274/1195348711455338596/360_F_620084766_fGRU1NqbRmNxiqw5EfY9oq1weKIo3FNH.png?ex=65b3aa3d&is=65a1353d&hm=bb6d9301cf7a5ac6cfa312b24e9d9bed778e4d99d5e9494427c9db2efe2329d2&=&format=webp&quality=lossless&size=4096`);
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://media.discordapp.net/attachments/1155364683755307028/1195344008717799454/360_F_605398028_61PN7u2bpFWQq1ppDcTpfw9919zWEzSt.png?ex=65b3a5dc&is=65a130dc&hm=050b4a9e6607918350c7dfbde2df47208bd04378e1ccc521afcf54e4601c5bae&=&format=webp&quality=lossless&size=4096`);
            ...
            const background = await canvas.loadImage(`https://media.discordapp.net/attachments/1164818134335766539/1195392315896901772/painting-bridge-body-water-generative-ai_900321-261.jpg?ex=65b3d2d9&is=65a15dd9&hm=4991dc2836eac3926fd8bf68a8c3d97c7cfedc78b2f14c731f6f5729bd19c0b6&=&format=webp&size=4096`);
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const background = await canvas.loadImage(`https://media.discordapp.net/attachments/1164818134335766539/1195392315896901772/painting-bridge-body-water-generative-ai_900321-261.jpg?ex=65b3d2d9&is=65a15dd9&hm=4991dc2836eac3926fd8bf68a8c3d97c7cfedc78b2f14c731f6f5729bd19c0b6&=&format=webp&782&size=4096`);
            ...
            throw new Error('Inavlid Theme, must be  one of:  "classic", "dynamic", "neon", "neonx"');
        }
    }
}
