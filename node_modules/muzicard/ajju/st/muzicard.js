...
class muzicard {
    ...
    async build() {
        ...
        if (this.theme == 'classic') {
            ...
            const bg2 = await canvas.loadImage("https://media.discordapp.net/attachments/1152621602614280274/1197851007762317383/Picsart_24-01-19_15-59-44-746.png?ex=65bcc4af&is=65aa4faf&hm=846857a6ebd6275f1f6bbf24dbe6ba395cf2373600cb014a245caf0b0790f974&=&format=webp&quality=lossless&size=4096")
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            const bg2 = await canvas.loadImage("https://media.discordapp.net/attachments/1152621602614280274/1197851007762317383/Picsart_24-01-19_15-59-44-746.png?ex=65bcc4af&is=65aa4faf&hm=846857a6ebd6275f1f6bbf24dbe6ba395cf2373600cb014a245caf0b0790f974&=&format=webp&quality=lossless&width=1101&height=386")
           ...
           ctx.drawImage(thumbnailCanvas, 70, 50, 350, 350);
            ...
            throw new Error('Inavlid Theme, must be  one of:  "classic", "dynamic", "neon", "neonx", "ravyy", "ravyyx", "anime", "animex", "space", "spacex"');
        }
    }
}
